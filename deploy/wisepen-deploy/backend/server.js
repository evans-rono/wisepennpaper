...
app.get('/admin',(req,res)=>res.type('html').send(renderAdmin(req))); app.get('/portal',(req,res)=>res.type('html').send(renderPortal(req))); app.get('/reset-password',(req,res)=>res.type('html').send(renderReset()));
